...
int Config::init(int argc, char **argv)
{
    ...
    m_settings.m_modelPath = "/Users/suneelbelkhale1/git/mlcv-mazerunner/OpenTLD/model";
    ...
    while((c = getopt(argc, argv, "a:b:d:e:fhi:j:m:n:Op:qst:z:")) != -1)
    {
        ...
        case 'm':
            ...
            m_settings.m_loadModel = true;
            m_settings.m_modelPath = string("/Users/suneelbelkhale1/git/mlcv-mazerunner/OpenTLD/model").append(optarg);//ss.str();
            m_modelPathSet = true;
            break;
        case 'n':
